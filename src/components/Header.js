					...
					{(ref) => (
						<div className="md:hidden" id="mobile-menu">
							<div ref={ref} className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
								<Link to='/' className="hover:bg-gray-300 text-white block px-3 py-2 rounded-md text-base font-medium">Home</Link>
								<Link to='/select-exercises' className="hover:bg-gray-300 text-white block px-3 py-2 rounded-md text-base font-medium">New Workout</Link>
								<Link to='/history' className="hover:bg-gray-300 text-white block px-3 py-2 rounded-md text-base font-medium">Workout History</Link>
								<Link to='/exercises' className="hover:bg-gray-300 text-white block px-3 py-2 rounded-md text-base font-medium">Exercises</Link>
							</div>
						</div>
					)}
				</Transition>
